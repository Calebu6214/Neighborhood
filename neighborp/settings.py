"""
Django settings for neighborp project.
...
SECRET_KEY = 'django-insecure-!cj#p0-^=rfy9ci=%p+y+*r!*2*9q@b81lj1*alou^n8dx(2!r'
...
WSGI_APPLICATION = 'neighborp.wsgi.application'
